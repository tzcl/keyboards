...
[[https://www.youtube.com/watch?v=TspN-VsGTFQ][One of the best budget boards]], the KBD67 Lite is great for started with mechanical keyboards. The 65% layout (67 keys in total) retains the arrow keys so there isn't much of a departure from a full-size keyboard. It comes with RGBs and a hotswap PCB so the build process is relatively simple.
